...
// #define SOUND_DEFAULT_ENVIRONMENT 4 //2 is Livingroom environment - has no reverb whatsoever
#define SURROUND_CAP	21 //Original: 7
#define SOUND_MAX_DISTANCE 21 //"world.view" of sounds. Increase this variable for GOONSOUND AAA
