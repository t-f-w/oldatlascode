...
/obj/mecha/combat/marauder/verb/zoom()
	...
	if(src.occupant.client)
		...
		if(zoom)
			src.occupant.client.reset_stretch = winget(src.occupant.client, "mapwindow.map", "icon-size")
...
/obj/mecha/combat/marauder/go_out()
	if(src.occupant && src.occupant.client)
		winset(src.occupant.client, "mapwindow.map", "icon-size=[src.occupant.client.reset_stretch]")
