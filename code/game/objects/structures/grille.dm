...
/obj/structure/grille/proc/shock(mob/user as mob, prb, obj/item/weapon/W as obj)
	...
	if(C)
		if(electrocute_mob(user, C, src, siemens_coefficient = W.siemens_coefficient))
