...
/mob/living/carbon/human/SpeciesCanConsume()
	var/obj/item/organ/limb/head/U = get_organ("head")
	if(U && U.has_slit_throat) //Can't eat anything with a slit throat!
		src << "<span class='notice'>You can't consume anything with a slit throat!</span>"
		return 0
