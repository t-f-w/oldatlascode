...
/mob/living/carbon/human/treat_message(message)
	...
	if(viruses.len) //TODO: make this loop through viruses and call a special virus proc instead, then adjust the message based on it's return.
