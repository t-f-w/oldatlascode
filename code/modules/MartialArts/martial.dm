...
/datum/martial_art/proc/basic_hit(var/mob/living/carbon/human/A,var/mob/living/carbon/human/D, var/damage = rand(0,9))
	...
	if(!damage)
		if(A.dna)
			playsound(D.loc, A.dna.species.miss_sound, 25, 1, -12)
		else
			playsound(D.loc, 'sound/weapons/punchmiss.ogg', 25, 1, -12)
	...
	if(A.dna)
		playsound(D.loc, A.dna.species.attack_sound, 25, 1, -7)
	else
		playsound(D.loc, 'sound/weapons/punch1.ogg', 25, 1, -7)
