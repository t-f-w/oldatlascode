...
/obj/item/weapon/reagent_containers/spray/luminol
	name = "luminol spray"
	desc = "Used to see blood traces if the blood was cleaned up recently.<br>Instructions: Spray around the presumed location of blood traces, equip science goggles to see the reaction."


/obj/item/weapon/reagent_containers/spray/luminol/New()
	..()
	reagents.add_reagent("luminol", 100) //Should be more than enough for 2-3 crime scenes
