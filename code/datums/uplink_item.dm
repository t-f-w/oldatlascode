...
/datum/uplink_item/stealthy_weapons/blackgloves
	name = "Black Gloves"
	desc = "Simple, black rubber gloves to hide your fingerprints. Syndicate Brand™"
	item = /obj/item/clothing/gloves/color/black/syndie
	cost = 2
